...
?>
       <div id="container">
            ...
            <div id="header_main">Max's Image Uploader</div><div id="header_right"></div></div>
            <div id="content">
<?php
if ($msg != ''){
...
?>
             ...
             <div id="footer"><a href="http://www.hariskhan.com.pk" target="_blank">Developed by Haris Khan</a></div>
         </div>
<?php
    }
